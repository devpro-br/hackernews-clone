  ...
  <v-container class="ma-0 pa-0">
    <v-row class="ma-0 pa-0">
      ...
      <v-col lg="7" md="7" xs="12" class="pa-12 flex-grow-1 flex-shrink-0">
        <div align="center" v-if="!loggedUser">
        ...
        <div align="center" v-else>
          <h1 class="pa-6 pt-12 grey--text text--darken-2">
            Hi {{ loggedUser.auth.name }}
          </h1>
          <p class="pa-2">
            <v-btn color="secondary" x-large @click="logout">
              <span class="grey--text text--darken-3 text-none">Logout</span>
            </v-btn>
          </p>
          <p class="pa-2">
            <v-btn text @click="newsList">
